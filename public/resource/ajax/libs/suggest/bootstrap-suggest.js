...
(function (factory) {
    ...
    function ajax(options, keyword) {
        ...
        if (preAjax && preAjax.abort && preAjax.readyState !== 4) {
            // console.monitor('abort pre ajax');
            preAjax.abort();
        }
    ...
    function getData(keyword, $input, callback, options) {
        ...
        // console.monitor(options.url + keyword);
        if (options.url) {
            var timer;
            ...
            return self.each(function() {
                ...
                $input.on('keydown', function(event) {
                    ...
                    keyupTimer = setTimeout(function() {
                        // console.monitor('input keyup', event);
                ...
                $dropdownMenu.mouseenter(function() {
                        // console.monitor('mouseenter')
                        isMouseenterMenu = 1;
                        $input.blur();
                    }).mouseleave(function() {
                        // console.monitor('mouseleave')
                        isMouseenterMenu = 0;
                        $input.focus();
