    	...
    	table: {
            ...
            selectDictLabel: function(datas, value) {
                ...
                $.each(datas, function(index, dict) {
                    if (dict.dict_value == ('' + value)) {
                    	var listClass = $.common.equals("default", dict.list_class) || $.common.isEmpty(dict.list_class) ? "" : "badge badge-" + dict.list_class;
                    	actions.push($.common.sprintf("<span class='%s'>%s</span>", listClass, dict.dict_label));
                        return false;
                    }
                });
                return actions.join('');
        ...
        operate: {
            ...
            successTabCallback: function(result) {
                if (result.code == web_status.SUCCESS) {
    	            ...
    	            var $contentWindow = $('.YunFan_iframe[data-id="' + currentId + '"]', topWindow)[0].contentWindow;
    	            $.modal.close();
