<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['DELETE:/monitor/jobLog']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleClean"
          v-hasPermi="['DELETEL/monitor/jobLog/clean']"
        >清空</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="jobLogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="任务组名" align="center" prop="job_group" :formatter="jobGroupFormat" :show-overflow-tooltip="true" />
