<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="登录时间" align="center" prop="last_access_time" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.last_access_time) }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['DELETE:/monitor/online']"
          >强退</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    handleForceLogout(row) {
      this.$confirm('是否确认强退名称为"' + row.login_name + '"的数据项?', "警告", {
