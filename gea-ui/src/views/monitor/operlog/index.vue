<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['GET:/system/operlog/export']"
        >导出</el-button>
      </el-col>
    </el-row>
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作地点" align="center" prop="oper_location" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['GET:/monitor/operlog/info']"
          >详细</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog title="操作日志详细" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="请求参数："><pre style='overflow:auto;background:#f5f5f5;max-height: 8rem;'>{{ form.oper_param }}</pre></el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="返回参数："><pre style='overflow:auto;background:#f5f5f5;max-height: 8rem;'>{{ form.json_result }}</pre></el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map(item => item.oper_id).join(",")
      this.multiple = !selection.length
    },
    /** 详细按钮操作 */
    handleView(row) {
      this.open = true;
      row.oper_param = JSON.parse(row.oper_param)
      row.json_result = JSON.parse(row.json_result)
      this.form = row;
    },
    /** 删除按钮操作 */
    handleDelete(row) {
