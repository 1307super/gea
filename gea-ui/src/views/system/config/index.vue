    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['DELETE:/system/config']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['GET:/system/config/export']"
        >导出</el-button>
      </el-col>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    typeFormat(row, column) {
      return this.selectDictLabel(this.typeOptions, row.config_type);
    },
    // 取消按钮
    cancel() {
      this.open = false;
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map(item => item.config_id).join(",")
