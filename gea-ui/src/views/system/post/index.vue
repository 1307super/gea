...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map(item => item.post_id).join(",")
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const postIds = row.post_id || this.ids;
