    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleImport"
              v-hasPermi="['GET:/system/user/import']"
            >导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleExport"
              v-hasPermi="['GET:/system/user/export']"
            >导出</el-button>
          </el-col>
        </el-row>
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户名称" align="center" prop="login_name" :show-overflow-tooltip="true" />
          <el-table-column label="用户昵称" align="center" prop="user_name" :show-overflow-tooltip="true" />
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                ...
                v-hasPermi="['PUT:/system/user/resetPwd']"
              >重置</el-button>
            </template>
          </el-table-column>
        </el-table>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="归属部门" prop="dept_id">
              <treeselect v-model="form.dept_id" :options="deptOptions" placeholder="请选择归属部门" :disable-branch-nodes="true" :show-count="true" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="手机号码" prop="phonenumber">
          ...
          <el-col :span="12">
            <el-form-item v-if="form.user_id == undefined" label="用户名称" prop="login_name">
              <el-input v-model="form.login_name" placeholder="请输入用户名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      this.ids = selection.map(item => item.user_id).join(",");
    ...
    handleUpdate(row) {
      this.reset();
      this.getTreeselect();
      const userId = row.user_id || this.ids;
      getUser(userId).then(response => {
        ...
        this.$set(this,"postOptions",response.data.posts)
    ...
    /** 重置密码按钮操作 */
    handleResetPwd(row) {
      this.$prompt('请输入"' + row.login_name + '"的新密码', "提示", {
        confirmButtonText: "确定",
        cancelButtonText: "取消"
      }).then(({ value }) => {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      const userIds = row.user_id || this.ids;
