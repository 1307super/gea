...
// arModel is a active record design model for table sys_job_log operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of sys_job_log.
	Table = "sys_job_log"
	// Model is the model object of sys_job_log.
