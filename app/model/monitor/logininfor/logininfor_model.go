...
// arModel is a active record design model for table sys_logininfor operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of sys_logininfor.
	Table = "sys_logininfor"
	// Model is the model object of sys_logininfor.
