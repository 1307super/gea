...
// arModel is a active record design model for table t_user_withdrawals operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of t_user_withdrawals.
	Table = "t_user_withdrawals"
	// Model is the model object of t_user_withdrawals.
