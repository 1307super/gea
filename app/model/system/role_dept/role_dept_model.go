...
// arModel is a active record design model for table sys_role_dept operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of sys_role_dept.
	Table = "sys_role_dept"
	// Model is the model object of sys_role_dept.
