...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='代码生成业务表';
...
) ENGINE=InnoDB AUTO_INCREMENT=436 DEFAULT CHARSET=utf8 COMMENT='代码生成业务表字段';
...
INSERT INTO `sys_job` VALUES (10, '电子合同定时同步状态', 'test', 'SYSTEM', 'Cntquerys', '0 0/5 * * * ?', '1', '1', '1', 'admin', '2020-04-22 15:36:06', '', NULL, '每5分钟同步一次合同状态');
INSERT INTO `sys_job` VALUES (11, 'test1', 'param1,param2', '', 'test1', '* * * * * *', '1', '1', '1', 'admin', '2020-06-22 12:04:30', '', '2020-06-22 12:10:31', '备注2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_job_log` VALUES (1, '电子合同定时同步状态', 'SYSTEM', 'Cntquerys', '电子合同定时同步状态，执行结果：我是返回值 总共耗时：2002毫秒', '0', '', '2020-07-17 10:06:37');
INSERT INTO `sys_job_log` VALUES (5, '电子合同定时同步状态', 'SYSTEM', 'Cntquerys', '电子合同定时同步状态，执行结果：map[aa:1 bb:1] 总共耗时：2003毫秒', '0', '', '2020-07-17 10:48:44');
INSERT INTO `sys_job_log` VALUES (6, '电子合同定时同步状态', 'SYSTEM', 'Cntquerys', '电子合同定时同步状态，执行结果：task.TestS{A:\"12\", B:10} 总共耗时：2005毫秒', '0', '', '2020-07-17 10:50:14');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` VALUES (1, '系统管理', 0, 1, 'system', NULL, 1, 'M', 0, 0, '', 'system', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '系统管理目录', NULL, NULL);
...
INSERT INTO `sys_menu` VALUES (4, '若依官网', 0, 4, 'http://www.truckgogo.com2', '', 0, 'M', 0, 0, '', 'guide', '', '2020-07-18 11:33:05', 'ry', '2018-03-16 11:33:00', '', '', NULL);
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1841 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
...
INSERT INTO `sys_role` VALUES (3, '员工', 'pop', 0, '2', '0', '0', 'admin', '2020-04-16 14:34:27', 'admin', '2020-07-18 11:31:41', '普通员工');
COMMIT;
...
INSERT INTO `sys_role_dept` VALUES (5, 110);
COMMIT;
...
INSERT INTO `sys_role_menu` VALUES (11, 110);
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 110, 'admin', '超级管理员', '00', '1307@qq.com', '', '0', '/upload/avatar/1/c3o6k3bwvquw6qiwrz', '9eb3cbe1c7c81a8d5982f295361ea4b2', 'Sp6Jqx', '0', '0', '127.0.0.1', '2020-01-13 13:20:40', 'admin', '2018-03-16 11:33:00', 'admin', '2020-01-27 08:53:05', '管理员111111');
COMMIT;
...
INSERT INTO `sys_user_online` VALUES ('GJWTadmin', 'admin', '', '127.0.0.1', '内网IP', 'Chrome', 'Intel Mac OS X 10_15_1', 'on_line', '2020-07-21 15:18:29', '2020-07-21 15:18:29', 864000);
